...
Route::middleware(['auth'])
    ...
    ->name('admin.')->group(function () {
        ...
        Route::controller(\App\Http\Controllers\Admin\WaterInvoicesController::class)->group(function () {
            Route::get('water-invoice', 'index')->name('water-invoice.index');
            Route::get('water-invoice/{id}/show', 'show')->name('water-invoice.show');
            Route::get('water-invoice/{id}/print', 'print')->name('water-invoice.print');
            Route::get('water-invoice/{id}/edit', 'edit')->name('water-invoice.edit');
        });
        ...
        Route::get('water-readings', WaterReadingController::class)->name('water-readings.index');
