...
class ExpensesController extends Controller
{
    ...
    public function index()
    {
        ...
        abort_unless(auth()->user()->can(config('permission.permissions.read_expenses')), 403);
        if (\request()->ajax()) {
    ...
    {
        abort_unless(auth()->user()->can(config('permission.permissions.create_expenses')), 403);
    ...
    {
        abort_unless(auth()->user()->can(config('permission.permissions.update_expenses')), 403);
    ...
    public function destroy($id)
    {
        ...
        abort_unless(auth()->user()->can(config('permission.permissions.delete_expenses')), 403);
