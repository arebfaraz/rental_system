...
class PaymentsController extends Controller
{
    public function index()
    {
        ...
        abort_unless(auth()->user()->can(config('permission.permissions.read_payments')), 403);
        ...
        if (\request()->ajax()) {
            ...
            return DataTables::of($payments)
                ...
                ->addColumn('invoice_link', function ($payment) {
                    return view('admin.payments.partials.invoice_link', compact('payment'))->render();
                })
                ->rawColumns(['reference_number', 'status', 'actions','invoice_link'])
                ->make(true);
        }
