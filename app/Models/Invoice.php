...
class Invoice extends Model
{
    ...
    {
        return $this->amount + $this->bills_amount - $this->verified_payments()->sum('amount');
    }
    public function getBalancePaidAttribute()
    {
        return $this->verified_payments()->sum('amount');
    }
    ...
    public function updateStatus(): void
    {
        ...
        //refresh the invoice before updating status to avoid stale data
