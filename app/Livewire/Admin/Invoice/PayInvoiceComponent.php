...
////        $this->dispatch('file-pond-clear', ['id' => $this->id]);
//
//        $this->reset(['amount', 'paid_at', 'payment_method', 'reference_number', 'recorded_by', 'receipt']);

        $message = 'Payment for invoice #' . $this->invoice->invoice_id . ' recorded successfully!';

        return redirect()->route('admin.rent-invoice.index')
