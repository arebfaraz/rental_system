...
class CreateBulkHousesComponent extends Component
{
    ...
    protected $rules = [
        ...
        'startNumber' => 'required|numeric|min:0',
    ...
    {
        $this->landlords = User::role('landlord')->select(['id', 'name', 'email'])->get()
    ...
    public function render()
    {
        ...
        return view('livewire.admin.house.create-bulk-houses-component',
            compact('types', 'properties')
        );
    }

    public function updatedBasePropertyId($value): void
    {
