...
class CreateLeaseComponent extends Component
{
    ...
    public bool $requires_tenant_signature = false;
    ...
    {
        $this->rent_cycle = 1;
        //generate random lease id that is unique
        $this->lease_id = Str::upper(Str::random(10));
    }
    ...
    public function updatedPropertyId($value): void
    {
        ...
        if ($value) {
            ...
            $property = Property::with(['houses' => function ($query) {
                $query->where('status', HouseStatusEnum::VACANT);
            }])->find($value);
...
//        }
        ...
        try {
            ...
            $lease = Lease::create([
                ...
                'require_tenant_signature' => $this->requires_tenant_signature,
                'lease_contract' => $this->lease_contract,
