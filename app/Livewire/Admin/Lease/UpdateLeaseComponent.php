...
class UpdateLeaseComponent extends Component
{
    ...
    public function mount()
    {
        ...
        $this->invoice_notes = $lease->invoice_notes;
        $this->initial_invoice_notes = $lease->invoice_notes;
    }
...
//        unset($this->bills[$index]);
    ...
    public function submit()
    {
        ...
        try {
            ...
            $lease->invoice_notes = $this->invoice_notes;
            $lease->save();
            $lease->bills()->delete();
