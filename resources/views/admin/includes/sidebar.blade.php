                ...
                <ul class="nk-menu">
                    ...
                    <li class="nk-menu-item has-sub {{ active(['admin.tenants.*','admin.archived-tenants.index']) }}">
                        ...
                        <ul class="nk-menu-sub">
                            @can(config('permission.permissions.create_tenant'))
                            ...
                            @can(config('permission.permissions.read_tenant'))
                    ...
                    @if(!config('rms.landlord_mode'))
                        <li class="nk-menu-item has-sub {{ active(['admin.landlords.*']) }}">
                            ...
                            <ul class="nk-menu-sub">
                                ...
                                @can(config('permission.permissions.create_landlord'))
                                ...
                                @can(config('permission.permissions.read_landlord'))
                    ...
                    <li class="nk-menu-item has-sub {{ active(['admin.properties.*','admin.houses.*']) }}">
                        ...
                        <ul class="nk-menu-sub">
                            @can(config('permission.permissions.read_property'))
                    ...
                    <li class="nk-menu-item has-sub {{ active(['admin.leases.*','admin.leases-history.*']) }}">
                        ...
                        <ul class="nk-menu-sub">
                            ...
                            @can(config('permission.permissions.read_lease'))
                            ...
                            @can(config('permission.permissions.read_lease_history'))
                    ...
                    @can(config('permission.permissions.read_water_reading'))

                        <li class="nk-menu-item {{ active('admin.water-readings.index') }}">
                            <a href="{{ route('admin.water-readings.index') }}"
                               class="nk-menu-link"
                            ...
                            <span class="nk-menu-icon">
                                ...
                                <span class="nk-menu-text">{{ __('Water Readings')}}</span>
                            </a>
                        </li>
                    @endcan
...
{{ active(['admin.rent-invoice.*','admin.custom-invoice.*','admin.vouchers.*','admin.expenses.*']) }} ">
                        ...
                        <ul class="nk-menu-sub">
                            ...
                            @can(config('permission.permissions.read_water_invoice'))
                                <li class="nk-menu-item {{ active('admin.water-invoice.*') }}">
                                    <a href="{{ route('admin.water-invoice.index') }}" class="nk-menu-link"><span
                                            class="nk-menu-text">{{ __('Water Invoices')}}</span></a>
                                </li>
                            @endcan

                            @can(config('permission.permissions.read_custom_invoice'))
                            ...
                            @can(config('permission.permissions.read_expenses'))
                    ...
                    <li class="nk-menu-item has-sub {{ active(['admin.settings.*','admin.backups.*','admin.activity-log.index']) }}">
                        ...
                        <ul class="nk-menu-sub">
                            @can(config('permission.permissions.access_settings'))
                            ...
                            @can(config('permission.permissions.access_activity_log'))
                    ...
                    @can(config('permission.permissions.access_user_management'))
