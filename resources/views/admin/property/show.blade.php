                                    ...
                                    <ul class="nav nav-tabs nav-tabs-mb-icon nav-tabs-card">
                                        ...
                                        @if ($property->is_multi_unit)
                                            ...
                                            <li class="nav-item nav-item-trigger d-xxl-none">
                                                ...
                                                @can(config('permission.permissions.create_property'))
                                            ...
                                            <div class="tab-pane active" id="tabDetails">
                                                <div class="nk-block nk-block-between">
                                                    ...
                                                    <div class="nk-block">
                                                        ...
                                                        @can(config('permission.permissions.update_property'))
                                            ...
                                            <div class="tab-pane" id="tabUnits">
                                                <div class="nk-block nk-block-between">
                                                    ...
                                                    <div class="nk-block">
                                                        ...
                                                        @can(config('permission.permissions.create_house'))
                                                ...
                                                <livewire:admin.property.property-units-table-component
