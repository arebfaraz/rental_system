                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped datatable-wrap">
                                            ...
                                            <tr>
                                                <td colspan="3"></td>
                                                <td>
                                                    {{ __('Paid Amount:')}} {{ setting('currency_symbol').' '.number_format($invoice->balance_paid,2) }}
                                                </td>
                                            </tr>
                                            ...
                                            {{ config('permission.permissions.create house') }}
                                        ...
                                        @if($invoice->invoice_notes)
                                            <div class="nk-notes"> {!! $invoice->invoice_notes  !!}   </div>
                                        @endif
