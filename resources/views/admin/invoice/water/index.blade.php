...
@section('content')
                    ...
                    <div class="nk-block-head nk-block-head-sm">
                        <div class="nk-block-between">
                            <div class="nk-block-head-content">
                                <h3 class="nk-block-title page-title">{{ __('Water Bill Invoices')}}</h3>
    ...
    <div class="modal fade" tabindex="-1" role="dialog" id="add-payment-modal" wire:ignore.self>
        <livewire:admin.invoice.pay-water-invoice-component/>
    </div><!-- .modal -->
    ...
    <script>
        $(document).ready(function () {
            ...
            let oTable = $("#tenants-list").DataTable(
                {
                    ...
                    "bLengthChange": false,
                    ajax: {
                        url: '{!! route('admin.water-invoice.index') !!}',
                        data: function (d) {
                    ...
                    columns: [
                        ...
                        {data: 'units_consumed', name: 'units_consumed', searchable: false, orderable: false},
            ...
            $('#modal-notify-tenant').on('hidden.bs.modal', function () {
                window.Livewire.dispatch('resetDetails');
            });
