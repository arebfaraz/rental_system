        ...
        <div class="drodown">
            ...
            <div
                ...
                <ul class="link-list-opt no-bdr">
                    ...
                    @can(config('permission.permissions.update_tenant'))
                    ...
                    @can(config('permission.permissions.create_lease'))
                        ...
                        <li>
                            <a href="{{ route('admin.leases.create',['tenant_id'=>$tenant->id]) }}">
                                <em class="icon ni ni-arrow-right-round"></em>
                                <span>{{__('Assign Room')}}</span>
                            </a>
                        </li>

                    @endcan

                    @can(config('permission.permissions.delete_tenant'))
