...
@section('content')
    ...
    <div class="modal fade" tabindex="-1" role="dialog" id="editPaymentModal" wire:ignore.self>
        <livewire:admin.invoice.edit-payment-component/>
    </div><!-- .modal -->

    <div class="modal fade" tabindex="-1" role="dialog" id="deletePaymentModal" wire:ignore.self>
        <livewire:admin.invoice.delete-payment-component/>
    </div><!-- .modal -->
            ...
            let oTable = $("#tenants-list").DataTable(
                {
                    ...
                    columns: [
                        ...
                        {data: 'invoice_link', name: 'invoice_link', searchable: false,orderable:false},
