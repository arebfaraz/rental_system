        ...
        <div class="card-inner-group">
                    ...
                    <div class="row gy-4 mb-3">
                        ...
                        <div class="col-xxl-3 col-lg-4 col-md-6">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    <select class="form-select" wire:model.change="property_id">
                        ...
                        <div class="col-xxl-3 col-lg-4 col-md-6">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    <select class="form-select" wire:model.live="house_id">
                ...
                <div class="nk-block-head nk-block-head-sm">
                    ...
                    <div class="nk-block">
                        <div class="col-12 mt-4">
                            <div class="form-group">
                                <x-filepond wire:model="lease_documents" multiple/>
                ...
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            ...
                            <p>{{ __('Add static lease bills that will be billed together with the lease.')}}</p>
                        </div><!-- .nk-block-head-content -->
                        <div class="nk-block-head-content">
                            @if(count($bills)==0)
                    ...
                    @foreach($bills as $index=>$bill)
                        <div class="row gx-2 pb-2" id="row-{{$index}}">
                            <div class="col-xxl-3 col-md-4">
                                <div class="form-group">
                                    <input type="text" wire:model="bills.{{$index}}.name"
            ...
            <div class="card-inner">
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            <h5 class="title nk-block-title">{{ __('Invoice Notes')}}</h5>
                            <p>{{ __('Footnotes that will be shown on all lease invoices.')}}</p>
                        </div><!-- .nk-block-head-content -->
                        <div class="nk-block-head-content">
                ...
                <div class="nk-block">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <x-rich-text id="invoice_notes" wire:model="invoice_notes"/>
                        </div>
                    </div>
            ...
            {{--                    <div class="nk-block-between">--}}
            {{--                        <div class="nk-block-head-content">--}}
            {{--                            <h5 class="title nk-block-title">{{ __('Lease Agreement Details')}}</h5>--}}
            {{--                            <p>{{ __('Documentation for the lease.')}}</p>--}}
            {{--                        </div><!-- .nk-block-head-content -->--}}
            {{--                        <div class="nk-block-head-content">--}}
            {{--                            <div class="custom-control custom-switch">--}}
            {{--                                <input type="checkbox" class="custom-control-input" id="customSwitch1" value="true"--}}
            {{--                                       wire:model="requires_tenant_signature">--}}
            {{--                                <label class="custom-control-label" for="customSwitch1">--}}

            {{--                                    <strong>--}}
            {{--                                        Allow Tenant To Sign--}}
            {{--                                    </strong>--}}
            ...
            {{--                    <div class="row">--}}
            {{--                        <div class="col-12">--}}
            {{--                            <x-rich-text id="agreement" wire:model="lease_contract"/>--}}
            {{--                        </div>--}}
            {{--                    </div>--}}
