    ...
    <div class="row gy-4">
        ...
        <div class="col-md-8">
            <div class="form-group">
                ...
                <div class="form-control-wrap">
                    ...
                    <x-tom-single-select wire:model="landlord"
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <div class="form-control-wrap">
                    <input type="number" class="form-control @error('rent') is-invalid @enderror" wire:model="rent"
                           min="0"
                           id="lead-name">
                    @error('rent')
                    <span class="invalid-feedback" role="alert">
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="close-deal" wire:model="description">
            </div>
        </div>
