    ...
    <div class="nk-block-head nk-block-head-lg">
        <div class="nk-block-between">
            <div class="nk-block-head-content">
                <h5 class="nk-block-title">{{ __('Locations')}}</h5>
                <span>{{ __('Locations to select when creating properties / house units.')}}</span>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">{{ $is_new ? 'Add':'Update'}} {{ __('Location')}}</h5>
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label class="form-label" for="full-name">{{ __('Location')}}
                            <x-form.required/>
                        </label>
                    ...
                    <div class="d-flex justify-content-end mt-3 mb-3">
                        ...
                        <x-button class="btn btn-primary" loading="{{__('Saving ...')}}" wire:click="submit">
                            {{ $is_new ? __('Add Location'):__('Update Location')}}
                        </x-button>
                    </div>
