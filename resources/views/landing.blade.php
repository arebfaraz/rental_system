...
<header id="header" class="fixed-top">
    <div class="container d-flex align-items-center justify-content-between">
        ...
        <h1 class="logo"><a href="/">Rental System</a></h1>
    ...
    <div class="container position-relative" data-aos="fade-up" data-aos-delay="100">
        <div class="row justify-content-center">
            <div class="col-xl-7 col-lg-9 text-center">
                <h1>{{ __('Rental Systems Portal')}}</h1>
...
<main id="main">
    ...
    <section id="cta" class="cta">
        <div class="container" data-aos="zoom-in">
            <div class="text-center">
                <h3>Contact Us</h3>
                <p>For any requests,errors,querys or assistance,you can contact us via email@email.com </p>
                <a class="cta-btn" href="#">Call Us {{ config('app.contact_phone') }}</a>
            </div>
        </div>
...
<footer id="footer">
    ...
    <div class="container d-md-flex py-4">
        ...
        <div class="me-md-auto text-center text-md-start">
            <div class="copyright">
                &copy; Copyright <strong><span>Rental System</span></strong>. All Rights Reserved
            </div>
            <div class="credits">
